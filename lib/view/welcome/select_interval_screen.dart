...
class _SelectIntervalScreenState extends State<SelectIntervalScreen> {
  ...
  void _trySubmit() async {
    ...
    if (isValid) {
      ...
      print("FOLDER NAME: ${myCameraController.projectNameController.value.text}");
      newPath = newPath + "/${myCameraController.projectNameController.value.text}";
      print(newPath);
                        ...
                        suffixIcon: PopupMenuButton<String>(
                          ...
                          onSelected: (String value) {
                            if (value == 'Custom') {
                              ...
                              myCameraController.intervalController.value.text = value[0];
                            }
                          },
                          itemBuilder: (BuildContext context) {
                            return intervals
                              ...
                              return PopupMenuItem(
                                  child: Text(value, style: Theme.of(context).textTheme.bodyText1?.copyWith(color: Colors.white),), value: value,);
                            }).toList();
                          },
                        ),
                      ),
